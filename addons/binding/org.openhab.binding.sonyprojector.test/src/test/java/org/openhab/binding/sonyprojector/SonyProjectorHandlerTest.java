...
/**
 * Test cases for {@link SonyProjectorHandler}. The tests provide mocks for supporting entities using Mockito.
 *
 * @author Markus - Initial contribution
 */
public class SonyProjectorHandlerTest extends JavaTest {
    ...
    public void setUp() {
        initMocks(this);
        handler = new SonyProjectorHandler(thing);
